...
<div class="box">
    ...
    <div>
        ...
        <a-button type="danger" ghost size="small" @click="delayInc(1000)">延迟加</a-button>
        <a-button type="danger" ghost size="small" @click="delayDec(1000)">延迟减</a-button>
        <a-button type="danger" ghost size="small" @click="stepInc(5)">按数量加</a-button>
        <a-button type="danger" ghost size="small" @click="stepDec(5)">按数量减</a-button>
        {{count}}
    </div>
